#!/bin/csh
#-----------------------------------------------------------------------
# Script to Run WoFS Forecasts at :30 past the hour
#-----------------------------------------------------------------------
...
if ( $cycle_start == "15" ) then
   #set times = (1730 1830 1930 2030 2130 2230 2330 0030 0130 0230)
   set times = (1730 1830 1930 2030 2130 2230 2330 0030 0130 0230 0330 0430 0530) 
endif

if ( $cycle_start == "17" ) then
   set times = (1930 2030 2130 2230 2330 0030 0130 0230)
endif

if ( $cycle_start == "18" ) then
   set times = (1930 2030 2130 2230 2330 0030 0130 0230 0330 0430 0530)
endif

if ( $cycle_start == "21" ) then
   set times = (2330 0030 0130 0230 0330 0430 0530)
endif
