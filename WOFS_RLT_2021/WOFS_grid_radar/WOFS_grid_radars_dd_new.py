...
import sys
import os
os.environ['PROJ_LIB'] = '/home/wof/miniconda3/share/proj'
...
if options.hwtdd:
    try:
        ...
        dir_json = '/home/wof/WOFS/run_scripts/WOFS_RLT_2021/WOFS_grid_radar/sfe_sectors/'
...
outfile.write("set rad_alt = ( %s )\n" % (' '.join([str(round(x,7)) for x in radar_alt])))
